...
public class Ajustaments extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagen = findViewById(R.id.ProfilePicture); //Buscamos su id
        ...
        emailContenido = findViewById(R.id.boxMail);
        emailContenido.setText(email);
    ...
    public void onBackPressed() {
        ...
        prefs.edit().putString("email",emailContenido.getText().toString()).commit();
    }
